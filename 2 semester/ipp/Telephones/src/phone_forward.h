...
struct PhoneForward;
/**
 * Definicja struktury przechowującej przekierowania.
 */
...
struct PhoneNumbers;
/**
 * Definicja struktury przechowującej numery telefonów.
 */
...
/** @brief Funkcja wyznacza numery, których prefiks jest przekierowany na prefiks
 * numeru @p num, takim numerem również jest numer @p num. Wynikowe numery są posortowane
...
/**
 * @brief Funkcja wyznaczająca przeciwobraz funkcji phfwdGet na konkretnym numerze.
 * @param pf - wskaźnik na strukturę przechowującą przekierowania numerów telefonu.
 * @param num - wskaźnik na numer.
 * @return - Wskaźnik na strukturę przechowującą wynikowe ciągi numerów telefonów, które przechodzą na
 * numer num.
 */
